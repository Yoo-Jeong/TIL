...
* 기존 프로그램에 나오는 외계인 우주선을 다 제거하고 나면 클리어 화면이 뜨도록 개선
* 기존 프로그램을 클리어 하면 난이도가 더 올라간 보스전이 나오도록 추가
* 보스는 기존 프로그램의 외계인 우주선보다 다가오는 속도가 빠르며 공격을 해온다.
* 플레이어 우주선 생명 추가
* 플레이어 우주선도 y축으로 이동가능하게 수정
